...
<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container">
        <div class="relative">
            ...
            <input type="text" x-model="datepickerValue" @click="showDatepicker = !showDatepicker"
                @keydown.escape="showDatepicker = false" {!! $attributes->merge(['class' => 'rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50']) !!} placeholder="Select date">
