<x-app-layout>
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-full px-3 mb-6">
                        ...
                        <x-input id="name"
                            class="block mt-1 w-full {{ $errors->has('title') ? 'border-red-600' : '' }}" type="text"
                            name="title" :value="old('title', $project->title)" placeholder="プロジェクト名" required
                            autofocus />
                    </div>
                </div>
            </div>
    ...
    <form name="deleteform" method="POST" action="{{ route('projects.destroy', ['project' => $project]) }}">
        ...
        <div class="w-full py-6 ml-6 flex justify-start">
            <x-button
                class=" m-2 px-10 bg-red-600 text-white hover:bg-red-700 active:bg-red-900 focus:border-red-900 ring-red-300"
